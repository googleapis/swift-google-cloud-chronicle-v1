...
extension Clients {
  final class RuleExecutionErrorServiceRetry: RuleExecutionErrorServiceStub {
    let inner: any RuleExecutionErrorServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any RuleExecutionErrorServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
