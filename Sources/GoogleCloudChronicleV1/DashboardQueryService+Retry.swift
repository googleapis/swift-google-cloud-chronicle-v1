...
extension Clients {
  final class DashboardQueryServiceRetry: DashboardQueryServiceStub {
    let inner: any DashboardQueryServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any DashboardQueryServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
