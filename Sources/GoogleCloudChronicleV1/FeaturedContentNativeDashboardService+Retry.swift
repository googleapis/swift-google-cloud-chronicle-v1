...
extension Clients {
  final class FeaturedContentNativeDashboardServiceRetry: FeaturedContentNativeDashboardServiceStub
  {
    let inner: any FeaturedContentNativeDashboardServiceStub
    let options: GoogleGax.ClientOptions

    public init(
      _ inner: any FeaturedContentNativeDashboardServiceStub, options: GoogleGax.ClientOptions
    ) {
      self.inner = inner
