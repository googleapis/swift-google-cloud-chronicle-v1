...
extension Clients {
  class DashboardQueryServiceTransport: DashboardQueryServiceStub {
    ...
    public func getDashboardQuery(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.DashboardQuery.self, from: data)
    }
    ...
    public func executeDashboardQuery(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/dashboardQueries:execute"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.ExecuteDashboardQueryResponse.self, from: data)
    }
