...
extension Clients {
  final class BigQueryExportServiceRetry: BigQueryExportServiceStub {
    let inner: any BigQueryExportServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any BigQueryExportServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
