...
extension Clients {
  final class DashboardChartServiceRetry: DashboardChartServiceStub {
    let inner: any DashboardChartServiceStub
    let options: GoogleCloudGax.ClientOptions

    public init(_ inner: any DashboardChartServiceStub, options: GoogleCloudGax.ClientOptions) {
      self.inner = inner
