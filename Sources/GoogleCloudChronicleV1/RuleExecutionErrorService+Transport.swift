...
extension Clients {
  class RuleExecutionErrorServiceTransport: RuleExecutionErrorServiceStub {
    ...
    public func listRuleExecutionErrors(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/ruleExecutionErrors"
      }()
      var query = [
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.ListRuleExecutionErrorsResponse.self, from: data)
    }
