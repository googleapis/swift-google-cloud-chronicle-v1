  ...
  class FeaturedContentNativeDashboardServiceTransport: FeaturedContentNativeDashboardServiceStub {
    ...
    public func getFeaturedContentNativeDashboard(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.FeaturedContentNativeDashboard.self, from: data)
    }
    ...
    public func listFeaturedContentNativeDashboards(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/featuredContentNativeDashboards"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.ListFeaturedContentNativeDashboardsResponse.self, from: data)
    }
    ...
    public func installFeaturedContentNativeDashboard(
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.InstallFeaturedContentNativeDashboardResponse.self, from: data)
    }
