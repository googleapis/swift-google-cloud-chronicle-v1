...
extension Clients {
  ...
  class BigQueryExportServiceTransport: BigQueryExportServiceStub {
    ...
    public func getBigQueryExport(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.BigQueryExport.self, from: data)
    }
    ...
    public func provisionBigQueryExport(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/bigQueryExport:provision"
      }()
      let query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
