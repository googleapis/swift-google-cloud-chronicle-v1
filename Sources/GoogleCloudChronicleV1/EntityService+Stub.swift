...
extension Clients {
  ...
  class EntityServiceTransport: EntityServiceStub {
    ...
    public func getWatchlist(
      ...
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.Watchlist.self, from: data)
    }
    ...
    public func listWatchlists(
      ...
      let path = try { () throws -> Swift.String in
        ...
        return "/v1/\(pathVariable0)/watchlists"
      }()
      var query = [
        URLQueryItem(name: "$alt", value: "json;enum-encoding=int")
      ]
      ...
      let (data, _) = try await self.inner.rpc(for: req).get()
      return try GoogleCloudWkt._ProtoJSONDecoder().decode(
        GoogleCloudChronicleV1.ListWatchlistsResponse.self, from: data)
    }
    ...
    public func updateWatchlist(
      ...
      let path = try { () throws -> Swift.String in
        guard let pathVariable0 = request.watchlist.map({ $0.name }), !pathVariable0.isEmpty else {
          throw GoogleCloudGax.RequestError.binding(
            "'request.watchlist.name' is not set or is empty")
        }
        return "/v1/\(pathVariable0)"
      }()
      var query = [
